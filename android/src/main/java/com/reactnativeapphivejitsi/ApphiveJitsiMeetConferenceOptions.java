 ...
 * instance by using {@link ApphiveJitsiMeetConferenceOptions.Builder} and setting the desired options
 * there.
 *
 * The resulting {@link ApphiveJitsiMeetConferenceOptions} object is immutable and represents how the
 * conference will be joined.
 */
public class ApphiveJitsiMeetConferenceOptions implements Parcelable {
    /**
     ...
     */
    private ApphiveJitsiMeetUserInfo userInfo;

    /**
     * Class used to build the immutable {@link ApphiveJitsiMeetConferenceOptions} object.
     */
    public static class Builder {
        ...
        public Builder setUserInfo(ApphiveJitsiMeetUserInfo userInfo) {
        ...
        /**
         * Builds the immutable {@link ApphiveJitsiMeetConferenceOptions} object with the configuration
         * that this {@link Builder} instance specified.
         * @return - The built {@link ApphiveJitsiMeetConferenceOptions} object.
         */
        public ApphiveJitsiMeetConferenceOptions build() {
            ApphiveJitsiMeetConferenceOptions options = new ApphiveJitsiMeetConferenceOptions();
    ...
    private ApphiveJitsiMeetConferenceOptions() {
    }

    private ApphiveJitsiMeetConferenceOptions(Parcel in) {
        room = in.readString();
        subject = in.readString();
        token = in.readString();
        colorScheme = in.readBundle();
        featureFlags = in.readBundle();
        userInfo = new ApphiveJitsiMeetUserInfo(in.readBundle());
    ...
    public static final Creator<ApphiveJitsiMeetConferenceOptions> CREATOR = new Creator<ApphiveJitsiMeetConferenceOptions>() {
        @Override
        public ApphiveJitsiMeetConferenceOptions createFromParcel(Parcel in) {
            return new ApphiveJitsiMeetConferenceOptions(in);
        }

        @Override
        public ApphiveJitsiMeetConferenceOptions[] newArray(int size) {
            return new ApphiveJitsiMeetConferenceOptions[size];
        }
    };
