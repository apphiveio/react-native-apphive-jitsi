...
public class ApphiveJitsiMeetView extends BaseReactView<JitsiMeetViewListener>
        implements ApphiveOngoingConferenceTracker.OngoingConferenceListener {
    ...
    public ApphiveJitsiMeetView(@NonNull Context context) {
        super(context);

        ApphiveOngoingConferenceTracker.getInstance().addListener(this);
    }

    @Override
    public void dispose() {
        ApphiveOngoingConferenceTracker.getInstance().removeListener(this);
        super.dispose();
    }
    ...
    /**
     * Joins the conference specified by the given {@link ApphiveJitsiMeetConferenceOptions}. If there is
     ...
     *                when doing so.
     */
    public void join(@Nullable ApphiveJitsiMeetConferenceOptions options) {
    ...
    /**
     * Handler for {@link ApphiveOngoingConferenceTracker} events.
     * @param conferenceUrl
     */
    @Override
